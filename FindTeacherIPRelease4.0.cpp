...
private:
    ...
    void impoliteModeThread(int threadId, int durationSeconds) {
        ...
        sockaddr_in teacherAddr;
        teacherAddr.sin_family = AF_INET;
        teacherAddr.sin_port = htons(5512); // 根据抓包，消息发送到5512端口
        teacherAddr.sin_addr.s_addr = inet_addr(targetIP.c_str());

        // 举手包数据 - 基于JuShou.csv中的实际数据
        // 从抓包看，学生机向教师机发送的包有多个类型
        // 这里我们使用一个通用的学生机到教师机的UDP包结构
        ...
        // 消息包基础结构 - 基于SendText.csv中的实际数据
        // 从抓包看，发送"123"的消息包长度为971字节
        ...
        // 设置消息类型为文本提交
        baseMessagePacket[44] = 0x54; baseMessagePacket[45] = 0x00; // T
        baseMessagePacket[46] = 0x45; baseMessagePacket[47] = 0x00; // E
        baseMessagePacket[48] = 0x58; baseMessagePacket[49] = 0x00; // X
        baseMessagePacket[50] = 0x54; baseMessagePacket[51] = 0x00; // T
        baseMessagePacket[52] = 0x53; baseMessagePacket[53] = 0x00; // S
        baseMessagePacket[54] = 0x55; baseMessagePacket[55] = 0x00; // U
        baseMessagePacket[56] = 0x42; baseMessagePacket[57] = 0x00; // B
        baseMessagePacket[58] = 0x4d; baseMessagePacket[59] = 0x00; // M
        baseMessagePacket[60] = 0x49; baseMessagePacket[61] = 0x00; // I
        baseMessagePacket[62] = 0x54; baseMessagePacket[63] = 0x00; // T
